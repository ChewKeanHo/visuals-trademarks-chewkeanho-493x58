...
* Horizontal: `10px` left + `30px` logo + `10px` right = `50px` total from left
...
```
   ...
   |------|-----------|------|--->
   |
3  |       +---------+        (Optional) Content Begins Here Centered Vertically
1  |       |   ...   |        (Optional) Content Begins Here Centered Vertically
.  |       |   ...   |        (Optional) Content Begins Here Centered Vertically
5  |       |   ...   |        (Optional) Content Begins Here Centered Vertically
px |       +---------+        (Optional) Content Begins Here Centered Vertically
   |
   |------|-----------|------|--->
     10px      30px     10px
```
...
UUID: 42CBCFE5-1169-4150-8EB6-DD05E210352D
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-25
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-chewkeanho-493x58
--------------------------------------------------------------------------------
```
